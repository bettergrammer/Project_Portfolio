        ...
        <div className="wrapper">
            <div id="skew2" className="cus-div">
                <div className="content">
                    <div className="coding-background-image-2"></div>
                    <div className="html5-logo"></div>
                    <div className="sass-logo"></div>
                    <div className="css3-logo"></div>
                    <h3>Front End Focused with Full Stack Experience</h3>
                    <p>
                    ...
                    <div className="express-logo"></div>
                </div>
            </div>
        </div>
    )
